...
<footer className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap max-[680px]:justify-center max-[680px]:items-start justify-between gap-4 md:gap-6'>
            ...
            <div className="flex flex-row md:justify-between gap-x-10 w-full md:w-fit max-w-80">
                <div>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='flex items-center justify-center bg-amber-500 h-9 w-9 aspect-square rounded-r'>
                        <img src={assets.arrowIcon} alt="arrow icon" className="hover:scale-110 w-4 invert"/>
                        </button>
                    </div>
                </div>
            </div>
