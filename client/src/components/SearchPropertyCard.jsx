...
const SearchPropertyCard = ({ property ,propertyId,type }) => {
    ...
    >
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-2/5 relative overflow-hidden">
          <img 
            onClick={() => navigate(`/${type}Details/${propertyId}`)}
          ...
          <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-medium flex items-center gap-1">
            ...
            <span className="font-semibold">{property.averageRating || 'New'}</span>
          </div>
        ...
        <div className="md:w-3/5 p-6 flex flex-col h-full">
          ...
          <div className="flex items-center gap-1 text-gray-500 mb-4 text-sm">
            ...
            <span className='text-amber-400'>{property.address.street}, {property.address.city}</span>
          </div>
          
          {property.amenities!=undefined && <div className="flex flex-wrap gap-2 mb-6">
          ...
          <div className="mt-auto flex items-center justify-between pt-4 border-t border-gray-100">
            <div>
              {property.basePricePerNight!=undefined && <><p className="text-2xl font-bold text-indigo-600">{property.basePricePerNight} Dh</p>
